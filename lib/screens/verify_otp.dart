import 'dart:async';
import 'package:findsafe/screens/reset_password.dart';
...
class VerifyOtpState extends State<VerifyOtp> {
  ...
  Future<void> _verifyOtp() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final result = await _authProvider.verifyResetOtp(
          context,
          widget.email,
          _otpController.text,
        );
  ...
  Future<void> _resendOtp() async {
    ...
    try {
      ...
      await _authProvider.sendPasswordResetEmail(context, widget.email);
